...
- **Frontend test suite** — vitest + React Testing Library (`frontend/src/App.test.jsx`, 11 specs) covering IOC-type derivation, the analyst's explicit type override reaching the request body, and the Cases list load path. The frontend previously had no tests at all.
